...
def getLink(soup):
    ...
    website_url = soup.find("a", title="List of American universities with Olympic medals")
    olympic_link = website_url['href']
    full_url = 'https://en.wikipedia.org' + olympic_link
    print(full_url)
